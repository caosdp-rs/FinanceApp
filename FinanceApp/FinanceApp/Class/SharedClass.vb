...
Public Class SharedClass
    ...
    Public Shared Function ValidDateddmmyy(ByVal value As Object) As Object
        Dim myret As Boolean = False
        If value = "" Then
            Return "Null"
        Else
            Dim separator As String = "/"
            If CType(value, String).Contains("-") Then
                separator = "-"            
            End If
            Dim myarr = CType(value, String).Split(separator)
            Dim myyear = IIf(myarr(2) < 2000, myarr(2) + 2000, myarr(2))
            Return CDate(myyear & "-" & myarr(1) & "-" & myarr(0))
        End If
        Return True
    End Function
