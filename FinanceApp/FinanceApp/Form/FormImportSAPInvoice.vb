...
Public Class FormImportSAPInvoice
    Dim myController As New ImportSAPInvoiceController
        ...
        Try
         ...
         '
                ...
                Try
                    If myList(i)(0).Length > 0 Then
                        ...
                        myInsert.Append(myList(i)(0) & vbTab &
                                        ...
                                        myList(i)(7) & vbTab &
                                        myList(i)(8) & vbTab &
                                        validdate(myList(i)(9)) & vbTab &
                                        validdate(myList(i)(10)) & vbTab &
                                        validdate(myList(i)(11)) & vbTab &
                                        validdate(myList(i)(12)) & vbTab &
                                        myList(i)(13) & vbTab &
                                        myList(i)(14).Replace(",", "") & vbTab &
                                        myList(i)(15).Replace(",", "") & vbTab &
                                        myList(i)(16) & vbTab &
                                        reference2 & vbCrLf)
                    End If
            ...
            If myInsert.Length > 0 Then
                ...
                mystr.Append(String.Format("delete from finance.sapinvoice;"))
                Dim ra As Long = 0
                ra = DbAdapter1.ExNonQuery(mystr.ToString)
                Dim sqlstr As String = "copy finance.sapinvoice(stat,vendor,documentno,myreference,mytype,sg,clrngcode,username,remarks,docdate,entrydate,postingdate,clearingdate,crcy1,amount1,amount2,crcy2,reference2) from stdin with null as 'Null';"
